...
include '../sesi.php';	
	...
	*/
	$aColumns = array( 'id_anggota', 'nama_anggota', 'jk', 'tgl_lahir', 'alamat'); //Kolom Pada Tabel
	
	// Indexed column (used for fast and accurate table cardinality)
	$sIndexColumn = 'id_anggota';
	
	// DB table to use
	$sTable = 'anggota'; // Nama Tabel
	...
	*/
	...
	// Looping Data
		...
		$row = array($aRow['id_anggota'], $aRow['nama_anggota'], $aRow['jk'], $aRow['tgl_lahir'], $aRow['alamat'], $btn );
		$output['aaData'][] = $row;
	}
